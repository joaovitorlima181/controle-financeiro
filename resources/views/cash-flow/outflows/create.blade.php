<!-- Main modal -->
<div id="create-outflow" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="create-outflow">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('outflows.store') }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Título da Saída de Caixa" required="required">
                    </div>
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="date"
                            class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Data de Saída</label>
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Descrição da sáide de caixa"></textarea>
                    </div>
                    <button type="submit"
