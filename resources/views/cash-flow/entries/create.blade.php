<!-- Main modal -->
<div id="create-entry" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="create-entry">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('entries.store') }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Venda para Fulano" required="required">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="amount"
                        ...
                        <input type="decimal" name="amount" id="amount"
                            ...
                            placeholder="R$100" required="required">
                    </div>                    
                    <div class="col-span-2 sm:col-span-1">
                    ...
                    <div class="col-span-2 sm:col-span-1">
                        <label for="entry_type" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Tipo
                            de Entrada</label>
                        <select id="entry_type" name="entry_type"
                            class="form-control @error('entry_type') is-invalid @enderror bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-500 focus:border-primary-500 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Venda do vestido Tal para Fulana"></textarea>
                    </div>
                    <button type="submit"
