...
<!-- Main modal -->
<div id="edit-entry-modal-{{ $id }}" tabindex="-1" aria-hidden="true"
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                ...
                <button type="button"
                    ...
                    data-modal-toggle="edit-entry-modal-{{ $id }}">
            ...
            <!-- Modal body -->
            <form class="p-4 md:p-5" action="{{ route('entries.update', $id) }}" method="POST">
                @csrf
                <div class="grid gap-4 mb-4 grid-cols-2">
                    <div class="col-span-2 sm:col-span-1">
                        ...
                        <input type="text" name="title" id="title"
                            ...
                            placeholder="Venda para Fulano" required="required" value="{{ $entry->title }}">
                    </div>
                    <div class="col-span-2 sm:col-span-1">
                        <label for="amount"
                        ...
                        <select id="entry_type" name="entry_type"
                            ...
                            @foreach ($entryTypes as $entryType)
                                @if ($entry->entry_type_id == $entryType->id)
                                    <option selected value="{{ $entryType->id }}">{{ $entryType->name }}</option>
                                @else
                    ...
                    <div class="col-span-2">
                        ...
                        <textarea id="description" name="description" rows="4"
                            ...
                            placeholder="Venda do vestido Tal para Fulana">{{ $entry->description }}</textarea>
                    </div>
                    <button type="submit"
